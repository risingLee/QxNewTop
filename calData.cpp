...
QString CalData::getKLine(QString code, QString type)
{
...
void CalData::saveKLine(QString code, QString type, QString value)
{
    QString dirPath = QCoreApplication::applicationDirPath()+"/"+type;
    QDir d;
    if(!d.exists(dirPath))
...
void CalData::slot_changeUrl(QString url)
{
    m_url = url;
    start();
}
